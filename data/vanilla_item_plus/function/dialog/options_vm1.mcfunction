...
data modify storage vanilla_item_plus:dialog dialog.body set value [{"type": "minecraft:item","item": {"id": "minecraft:oak_log"},"description": {"contents": "以下是属于vm-1的选项"},"show_decorations": false,"show_tooltip": false}]
data modify storage vanilla_item_plus:dialog dialog.body append value {"type": "minecraft:plain_message","contents": [{"text": "注意，由于","color":"red","bold":true},{"text":"[MC-143214]","color":"blue","underlined":true,"click_event":{"action":"open_url","url":"https://bugs.mojang.com/browse/MC/issues/MC-143214"}},{"text":"的存在，以下选项暂不可在游戏内更改：","color":"red","bold":true},"\n",{"text":"切石机切木:","color":"white"}]}
