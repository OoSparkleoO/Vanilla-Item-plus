...
data modify storage vanilla_item_plus:dialog dialog.body set value [{"type": "minecraft:item","item": {"id": "minecraft:purpur_block"},"description": {"contents": "Following are options belong to vm-2"},"show_decorations": false,"show_tooltip": false}]
...
data modify storage vanilla_item_plus:dialog dialog.actions append value {"label": ["Ominous vault rewards elytra:"]}
...
data modify storage vanilla_item_plus:dialog dialog.actions append value {"label": ["Recover old recipe of enchanted golden apple:"]}
...
data modify storage vanilla_item_plus:dialog dialog.actions append value {"label": ["Dividable quartz blocks:"]}
...
data modify storage vanilla_item_plus:dialog dialog.actions append value {"label": ["Head hunter:"]}
...
data modify storage vanilla_item_plus:dialog dialog.actions append value {"label": ["Decoration spawner:"]}
...
data modify storage vanilla_item_plus:dialog dialog.actions append value {"label": ["Infinite vault:"]}
